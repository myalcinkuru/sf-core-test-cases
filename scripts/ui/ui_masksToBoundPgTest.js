...
// Constructor
function $MasksToBoundPgTest(_super, props) {
	...
	pageContextPatch(this, 'masksToBoundPgTest');
}
$MasksToBoundPgTest.$$styleContext = {
	classNames: '.sf-page',
...
const $MasksToBoundPgTest_ = Page($MasksToBoundPgTest);
...
function onLoad() {
	// HeaderBar props
	this.headerBar.title = 'masksToBoundPgTest';
}

module.exports = $MasksToBoundPgTest_;
