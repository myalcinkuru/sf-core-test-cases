...
// Constructor
function $ButtonTest(_super, props) {
	...
	pageContextPatch(this, 'buttonTest');
}
$ButtonTest.$$styleContext = {
	classNames: '.page',
...
const $ButtonTest_ = Page($ButtonTest);
...
function onLoad() {
	// HeaderBar props
	this.headerBar.title = 'buttonTest';
}

module.exports = $ButtonTest_;
